const scrapeJS = require('./sjs.js')
const scrapeTOM = require('./stom.js')
const scrapeSJSFeatured = require('./sjsFeatured.js')
const scrapeSTOMFeatured = require('./stomFeatured.js')
